...
export const skillsData = [
  ...
  },
  {
    ...
    name: "React",
    content:
      "컴포넌트의 재사용과 유지보수의 향상을 위해 컴포넌트 단위로 코드를 작성 하며, useState, useEffect, useRef 같은 기본적인 hook 사용에 능숙합니다. ",
  },
  {
    id: 2,
    logoImg: recoilLogo,
  ...
  },
  {
    ...
    content:
      "props를 사용해 조건부 렌더링을 할 수 있는 장점을 적극적으로 활용하며, ThemeProvider로 공통 스타일 속성 관리를 할 수 있습니다.",
  },
  {
    id: 5,
    logoImg: htmlLogo,
  ...
  },
  {
    ...
    name: "CSS3",
    content:
      " 적절한 선택자와 css 변수를 사용할 수 있고, flexBox, position 속성을 활용해 레이아웃을 구성할 수 있습니다. 웹을 반응형으로 만들 수 있습니다.",
  },
];
